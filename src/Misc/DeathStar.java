...
import ParaTestear.AlwaysRotate;
...
public class DeathStar {
    ...
    public void get() {
        ...
        deathStar.getTransform().setZcomponent(293);Renderizable death = new Renderizable(new SpriteData(Paths.DeathStar, new Vector2(500, 500)));
